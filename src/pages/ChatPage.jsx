...
function ChatPage() {
  ...
  const handleReaction = async (messageId, emoji) => {
    ...
    } catch { toast.error("Errore reazione"); }
  };
                  ...
                  <div className="max-w-xs sm:max-w-sm lg:max-w-md space-y-0.5">
                    ...
                    <div className="relative">
                      {deleted ? (
                        ...
                        <div className={`px-4 py-2 rounded-2xl text-sm ${mine ? "bg-blue-500 text-white rounded-tr-sm" : "bg-white text-gray-800 shadow-sm rounded-tl-sm"}`}>
                          {msg.content}
                        </div>
                      ) : null}
