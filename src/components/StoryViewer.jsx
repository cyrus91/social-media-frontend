...
function StoryViewer({ groups, initialGroupIndex = 0, onClose, onStoryDeleted }) {
  ...
  return createPortal(
    <div
      ...
      {/* ── MEDIA contenuto nel box story centrato ── */}
      <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "100%", maxWidth: "420px", height: "100%", overflow: "hidden", background: "#000" }}>
        {isVideo ? (
        ...
        <div style={{ display: "none", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px", color: "rgba(255,255,255,0.5)", width: "100%", height: "100%" }}>
